...
print("inline const char* txlookup_type_name(int tx_type) {")
print("\tswitch(tx_type) {\n")
for x in TXLookup:
    print("\t\tcase " + str(x) + ": {")
    print("\t\t\treturn \"" + TXLookup[x] + "\";")
    print("\t\t}")
print("\t\tdefault: {")
print("\t\t\treturn \"UNKNOWN_TX_TYPE\";")
print("\t\t}")
print("\t}\n}")



print("inline const char* lelookup_type_name(int le_type) {")
print("\tswitch(le_type) {\n")
for x in LELookup:
    print("\t\tcase " + str(x) + ": {")
    print("\t\t\treturn \"" + LELookup[x] + "\";")
    print("\t\t}")
print("\t\tdefault: {")
print("\t\t\treturn \"UNKNOWN_LE_TYPE\";")
print("\t\t}")
print("\t}\n}")

print("inline const char* stlookup_type_name(int st_type) {\n\tswitch(st_type) {")
for x in STLookup:
    print("\t\tcase " + str(x) + ": {" )
    print("\t\t\treturn \"" + STLookup[x]['type_name'] + "\";\n\t\t}")
print("\t\tdefault: {\n\t\t\treturn \"UNKNOWN_ST_TYPE\";\n\t\t}")
print("\t}\n}")

print("inline int stlookup_type_size(int st_type) {\n\tswitch(st_type) {")
for x in STLookup:
    print("\t\tcase " + str(x) + ": {" )
    if 'size' in STLookup[x]:
        print("\t\t\treturn " + str(STLookup[x]["size"]) + ";\n\t\t}")
    else:
        print("\t\t\treturn 0;\n\t\t}")
...
print("inline const char* stlookup_field_name(int st_type, int field_type) {\n\tswitch(st_type) {")
for x in STLookup:
    print("\t\tcase " + str(x) + ": {" )
    print("\t\t\tswitch(field_type) {")
    for y in STLookup[x]:
        if (type(y) == str):
            continue
        print("\t\t\t\tcase " + str(y) + ": {")
        print("\t\t\t\t\treturn \"" + STLookup[x][y]['field_name'] + "\";")
        print("\t\t\t\t}")
    print("\t\t\t\tdefault: {")
    print("\t\t\t\t\treturn \"UNKNOWN_FIELD_TYPE\";")
    print("\t\t\t\t}")        
    print("\t\t\t}")        
    print("\t\t}" )
...
print("inline int stlookup_field_info(int st_type, int field_type) {\n\tswitch(st_type) {")
for x in STLookup:
    print("\t\tcase " + str(x) + ": {" )
    print("\t\t\tswitch(field_type) {")
    for y in STLookup[x]:
